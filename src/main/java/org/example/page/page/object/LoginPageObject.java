...
public class LoginPageObject extends BasePage {
    ...
    public final String LOGIN_PAGE_URL = "https://stellarburgers.nomoreparties.site/login";
    public final By EMAIL_FIELD = By.xpath(".//label[text()='Email']");
    public final By PASSWORD_FIELD = By.xpath(".//label[text()='Пароль']");
    public final By ENTER_BUTTON = By.cssSelector("#root > div > main > div > form > button");
    public final By REGISTRATION_BUTTON = By.xpath(".//a[text()='Зарегистрироваться']");
