...
public class RegistrationPageObject extends BasePage {
    ...
    private final String REGISTRATION_PAGE_URL = "https://stellarburgers.nomoreparties.site/register";
    private final By NAME_FIELD = By.xpath(".//label[text()='Имя']");
    private final By EMAIL_FIELD = By.xpath(".//label[text()='Email']");
    private final By PASSWORD_FIELD = By.xpath(".//label[text()='Пароль']");
    private final By REGISTRATION_BUTTON = By.xpath(".//button[text()='Зарегистрироваться']");
    private final By INCORRECT_PASS_MESSAGE = By.xpath(".//p[text()='Некорректный пароль']");
